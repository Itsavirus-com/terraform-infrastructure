...
module "ecs" {
    ...
    repository_url = module.ecr.frontend_ecr_url
...
module "ecr" {
    source  = "../../../terraform-modules/production/production-ecs/ecr"
...
module "cloudwatch" {
    source  = "../../../terraform-modules/production/production-ecs/cloudwatch"
...
module "s3" {
    source = "../../../terraform-modules/production/production-ecs/s3"
